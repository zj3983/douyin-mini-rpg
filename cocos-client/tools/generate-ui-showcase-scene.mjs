...
const { width: designWidth, height: designHeight } = tokens.designResolution
...
scene.push(
  {
    ...
    _children: [{ __id__: 10 }],
    _active: true,
    _components: [{ __id__: 13 }, { __id__: 14 }, { __id__: 15 }],
    _prefab: null,
  ...
  },
  {
    ...
    _enabled: true,
    __prefab: null,
    _contentSize: { __type__: 'cc.Size', width: designWidth, height: designHeight },
